...
const Revolution = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      iconMaxWidth: matchesMD ? 300 : 800,
      iconMaxHeight: matchesMD ? 400 : undefined,
    ...
    },
    {
      ...
      iconAlt: "rocket",
      iconMaxWidth: 200,
      iconMaxHeight: matchesMD ? 500 : undefined,
  ...
  return (
    <Grid container direction="column">
      <Head>
        <title key="title">
          The Revolution - Cutting-Edge Software | Baz Development
        </title>
        <meta
          name="desription"
          key="description"
        ...
        />
        <meta key="og:url" property="og:url" content="baz.com/revolution" />
        <link rel="canonical" key="canonical" href="baz.com/revolution" />
      </Head>
      ...
      {sections.map((section) => {
        return (
          <Grid
            ...
            className={classes.rowContainer}
            style={{ backgroundColor: section.backgroundColor, height: "80em" }}
          >
            <Grid
              item
              container
            ...
            <Grid
              item
              lg
              style={{ alignSelf: matchesMD ? undefined : "center" }}
            >
              <LazyLoadImage
                threshold={300}
                src={section.icon}
