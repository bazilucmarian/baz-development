...
const Estimate = () => {
  ...
  return (
    <Grid container direction="row">
      <Head>
        <title key="title">
          Free Custom Software Estimate | Baz Development
        </title>
        <meta
          name="desription"
          key="description"
          content="Use our free online estimate calculator to instalntly check the cost of your custom software, mobile app or website design and development"
        />
        <meta
          key="og:title"
          property="og:title"
        ...
        />
        <meta key="og:url" property="og:url" content="baz.com/estimate" />
        <link rel="canonical" key="canonical" href="baz.com/estimate" />
      </Head>
      <Grid
        item
        container
